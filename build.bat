@echo off
chcp 65001 >nul
title StreamScribe Build Script v2.0.1

echo.
echo ========================================
echo 🚀 StreamScribe Build Script v2.0.1
echo ========================================
echo.
...
if not exist "dist\Streamscribe_v2.0.1_Standalone.exe" (
    echo.
...
:: Get file size
for %%A in ("dist\Streamscribe_v2.0.1_Standalone.exe") do set size=%%~zA
...
echo    - Executable: dist\Streamscribe_v2.0.1_Standalone.exe
...
dist\Streamscribe_v2.0.1_Standalone.exe --version >nul 2>&1
if errorlevel 1 (
...
echo    - dist\Streamscribe_v2.0.1_Standalone.exe (Ana uygulama)
...
echo.
echo 🎬 StreamScribe v2.0.1 build işlemi tamamlandı!
echo.
pause